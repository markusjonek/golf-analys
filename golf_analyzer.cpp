...
Mat model(const Mat& frame){
    auto model = readNet("/Users/markusjonek/Documents/golf-analys/obj_det_model/frozen_inference_graph.pb","/Users/markusjonek/Documents/golf-analys/obj_det_model/ssd_mobilenet_v2_coco_2018_03_29.pbtxt", "TensorFlow");
...
vector<string> class_txt_conv() {
    ...
    ifstream ifs(string("/Users/markusjonek/Documents/golf-analys/obj_det_model/object_detection_classes_coco.txt").c_str());
    string line;
...
void normal(string file_path){
    video_display(file_path, 3,  false, false);
}
